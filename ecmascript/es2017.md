...
The expression after `await` will returns a promise, and waits until the promise is resolved or rejected.

在 ECMAScript 2017 之前，对于异步，可以使用 Promise 或 callback。理解这三者之间的发展和异同尤为重要。
